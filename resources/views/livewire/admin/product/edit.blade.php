            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Edit details about the products</p>
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Edit publish information</p>
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Edit thumbnail or product gallery</p>
                                ...
                                <div class="border rounded">
                                    @if ($productImages && $productImages->isNotEmpty())
                                        @foreach ($productImages as $pimage)
                                            <div
                                                class="d-flex flex-wrap justify-content-between align-items-center p-2">
                                                ...
                                                <div class="flex-shrink-0 ms-3">
                                                    <button class="btn btn-sm btn-danger"
                                                        wire:click.prevent="deleteImage('{{ $pimage->id }}')">Delete</button>
                                                </div>
                                            </div>
                                        @endforeach
                                    @else
                                        <p class="p-2">This product doesn't have images.</p>
                                    @endif
                                </div>
                            </li>
                        </ul>

...
<section>
                            ...
                            <div class="search-box">
                                <div class="position-relative">
                                    <input id="search" name="search" type="text" class="form-control"
                                        autocomplete="off" id="searchTableList" placeholder="Search slider..."
                                        ...
                                        <tr>
                                            <td>
                                                <input type="checkbox" id="checkedItems_{{ $index }}"
                                                    ...
                                                    value="{{ $slider->id }}" wire:model="checkedItems"
                                                    wire:change="updateFilter">
                                            </td>
                                            <td>
                                                @if ($slider->image)
                                                    <img src="{{ Storage::url($slider->image) }}" alt="img"
                                                        title="{{ $slider->name }}" class="avatar-sm rounded" />
                                                @else
                                                    <span>No Img</span>
                                                @endif
                                            </td>
                                            <td>
                                                <h5 class="font-size-14 text-dark text-truncate mb-1">
                                                    {{ $slider->name }}</h5>
                                                <span>Slug : <span class="fw-medium">{{ $slider->slug }}</span></span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge badge-pill font-size-11 @if ($slider->visibility == '1') badge-soft-danger @else badge-soft-success @endif">
                                                    {{ $slider->visibility == '0' ? 'Publish' : 'Private' }}
                                                </span>
                                            </td>
                                            <td>
    ...
    @include('livewire.admin.slider.add')
    @include('livewire.admin.slider.edit')
    @include('livewire.admin.slider.delete')
    @include('livewire.admin.slider.selected')
</section>

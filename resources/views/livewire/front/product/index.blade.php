<section class="shop-main d-flex">
    <div class="shop-sidebar side-sticky bg-body" id="shopFilter">
        ...
        <div class="accordion mb-4" id="brands-filters">
            <div class="accordion-item">
                <h5 class="accordion-header" id="accordion-heading-brands">
                    <button class="accordion-button p-0 border-0 fs-6" type="button" data-bs-toggle="collapse"
                        data-bs-target="#accordion-filter-brands" aria-expanded="true"
                        aria-controls="accordion-filter-brands">
                        Brands
                        ...
                        <ul class="multi-select__list list-unstyled">
                            <li class="search-suggestion__item">
                                <input type="checkbox" id="brand1" class="form-check-input"
                                    wire:change="updateFilter" value="" />
                                <label for="brand1">
                                    Apple
                                </label>
                            </li>
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
            <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
                ...
                <a href="/shop/{{ $category->slug }}"
                    class="menu-link menu-link_us-s fw-medium">{{ $category->name }}</a>
            </div>
        ...
        <div class="products-grid row" id="products-grid">
                            ...
                            <div class="background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a
                                            href="{{ url('/shop/' . $product->category->slug . '/' . $product->slug) }}">
            ...
            @empty
                <div class="col-12">
                    ...
                    <p>No product available for {{ $category->name }} category.</p>
                    <a href="{{ url()->previous() }}" class="link__text text__more">Go back <i

    ...
    <div class="navbar-header">
        <div class="d-flex flex-row-reverse flex-lg-row">
            <div class="navbar-brand-box">
                <a href="{{ route('admin.dashboard') }}" wire:navigate class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('assets/images/logo.svg') }}" alt="logo" height="22">
                    </span>
                    <span class="logo-md mb-05">
                        <img src="{{ asset('front/images/logo.jpg') }}" alt="logo" height="12">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('front/images/logo.jpg') }}" alt="logo" height="12">
                    </span>
            ...
            <button type="button" class="btn btn-sm px-3 font-size-18 header-item waves-effect mt-05" id="vertical-menu-btn">
                ...
                <div class="dropdown-menu dropdown-megamenu">
                    <div class="row">
                        <div class="col-sm-8">
                            <div class="row">
                                <div class="col-md-4">
                                    <h5 class="font-size-14" key="t-ui-components">Ecommerce</h5>
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="{{ route('admin.products.index') }}" wire:navigate>Products</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('admin.products.add') }}" wire:navigate>Add Products</a>
                                        </li>
                                        <li>
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <ul class="list-unstyled megamenu-list">
                                        <li>
                                            <a href="javascript:void(0);" wire:navigate>Lightbox</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-5">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="#"><i class="bx bx-user font-size-16 align-middle me-2"></i>
                        <span key="t-profile">Profile</span></a>
                    <a class="dropdown-item" href="#"><i
                            class="bx bx-wallet font-size-16 align-middle me-2"></i> <span key="t-my-wallet">My
                            Wallet</span></a>
                    <a class="dropdown-item d-block" href="#"><span
                            class="badge bg-success float-end">11</span><i
                            class="bx bx-wrench font-size-16 align-middle me-2"></i> <span
                            key="t-settings">Settings</span></a>
                    <a class="dropdown-item" href="#"><i
                            class="bx bx-lock-open font-size-16 align-middle me-2"></i> <span key="t-lock-screen">Lock
                            screen</span></a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-danger" href="{{ route('logout') }}"
                        onclick="event.preventDefault();
                                  document.getElementById('logout-form').submit();"><i
                            class="bx bx-log-out font-size-16 align-middle me-2 text-danger"></i> <span

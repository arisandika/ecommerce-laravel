...
window.addEventListener("load", () => {
    ...
    loader.addEventListener("transitionend", () => {
        // Hapus elemen hanya jika loader masih merupakan anak dari body
        if (document.body.contains(loader)) {
            document.body.removeChild(loader);
        }
    });

    // Tambahkan delay sebelum menyembunyikan loader
    setTimeout(() => {
        loader.classList.add("loader__hidden");
    }, 1000); // Sesuaikan dengan durasi transisi Anda
});

document.addEventListener("DOMContentLoaded", function () {
    var currentUrl = window.location.href;

    var links = document.querySelectorAll(".account-nav .menu-link");
...
function purecookieDismiss() {
    setCookie("purecookieDismiss", "1", 1); // Mengubah masa berlaku menjadi 1 jam
...
function setCookie(e, o, i) {
    ...
    if (i) {
        var n = new Date();
        n.setTime(n.getTime() + i * 60 * 60 * 1e3); // Mengubah i menjadi jumlah jam (dalam milidetik)

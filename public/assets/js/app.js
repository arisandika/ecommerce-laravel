...
document.addEventListener("DOMContentLoaded", function () {
    ...
    textarea.addEventListener("input", function () {
        ...
        // Ganti * (bintang dan spasi) dengan <li>
        content = content.replace(/\* /g, "<li>");

        // Ganti - (tanda hubung) dengan <hr>
        content = content.replace(/- /g, "<hr>");

        // Ganti # (tanda pagar) dengan tag <h2>
        content = content.replace(/# /g, "<h2>");

        // Ganti ## (dua tanda pagar) dengan tag <h3>
        content = content.replace(/## /g, "<h3>");

        // Ganti *** (tiga bintang) dengan <strong>...</strong>
        content =
            content.replace(/\*\*\*/g, "<strong>") +
            content.replace(/\*\*\*/g, "</strong>");

        // Set nilai textarea yang sudah dimodifikasi
